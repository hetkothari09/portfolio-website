  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="card p-6 space-y-6 border border-primary border-opacity-20 relative overflow-hidden">
            {/* Animated scan line */}
            <motion.div 
          ...
          <motion.div 
            className="mt-8 card p-6 border border-primary border-opacity-20"
        ...
        >
          <div className="relative">
            ...
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-primary border-opacity-30 glow-effect">
              <div className="w-full h-full bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
                <div className="flex flex-col items-center">
                  <FiCpu size={40} className="text-primary mb-2" />
                  <span className="text-4xl font-bold text-primary font-mono">HK</span>
                  <div className="mt-2 text-xs font-mono text-slate-400">SYSTEM_CORE</div>
                </div>
              </div>
              ...
              <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
                ...
                <div className="absolute top-3/4 right-1/4 w-1 h-1 bg-primary rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
                <div className="absolute top-1/2 right-1/4 w-1 h-1 bg-primary rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
                <div className="absolute bottom-1/4 left-1/3 w-1 h-1 bg-primary rounded-full animate-pulse" style={{ animationDelay: '1.5s' }}></div>
              </div>
            </div>
            ...
            {/* Achievement badge */}
            <motion.div 
              className="absolute -bottom-4 -right-4 bg-black p-3 rounded-md border border-primary border-opacity-30"
